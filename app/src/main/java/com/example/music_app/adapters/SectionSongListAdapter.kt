...
import com.example.music_app.databinding.SectionSongListRecylerRowBinding
...
class SectionSongListAdapter(private val songIdList: List<String>) :
    ...
    class MyViewHolder(private val binding: SectionSongListRecylerRowBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = SectionSongListRecylerRowBinding.inflate(
